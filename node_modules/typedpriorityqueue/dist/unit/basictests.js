...
var TypedPriorityQueue_1 = require("../TypedPriorityQueue");
describe('TypedPriorityQueue', function () {
    ...
    it('example1', function () {
        var x = new TypedPriorityQueue_1.TypedPriorityQueue(function (a, b) {
            return a < b;
        });
        x.add(1);
        x.add(0);
    ...
    it('Random', function () {
        for (var ti = 0; ti < 100; ti++) {
            var b = new TypedPriorityQueue_1.TypedPriorityQueue(function (a, b) {
                return a < b;
            });
            var N = 1024 + ti;
            for (var i = 0; i < N; ++i) {
