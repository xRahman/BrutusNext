...
export class PrototypeManager extends SaveableObject
{
  ...
  public addNewPrototype(param: { name: string, ancestor: string }): boolean
  {
    if (!ASSERT(param.name !== ""
              && param.name !== null
