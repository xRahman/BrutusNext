...
export class NamedClass
{
  ...
  public static set className(className: string)
  {
    ...
    // dynamically created classes (prototype classes), which don't have
    // 'constructor.name'.
  ...
  {
    /// Tohle cele nejspis neni potreba, protoze jsem pridal staticky
    /// accessor, ktery vraci constructor.name.
    /*
