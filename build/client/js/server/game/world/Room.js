...
*/
define(["require", "exports", "../../../server/game/GameEntity", "../../../shared/lib/class/Classes", "../../../shared/game/world/RoomData"], function (require, exports, GameEntity_1, Classes_1, RoomData_1) {
    /*
    ...
    */
    ...
    class Room extends GameEntity_1.GameEntity {
        constructor() {
            super();
            this.data = new RoomData_1.RoomData(this);
    ...
    exports.Room = Room;
    Classes_1.Classes.registerEntityClass(Room);
});
