...
define(["require", "exports", "../../shared/lib/error/ERROR", "../../shared/lib/entity/Entities", "../../server/lib/message/Message", "../../shared/lib/message/MessageType", "../../server/lib/entity/ContainerEntity"], function (require, exports, ERROR_1, Entities_1, Message_1, MessageType_1, ContainerEntity_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    class GameEntity extends ContainerEntity_1.ContainerEntity {
        constructor() {
            // ----------------- Public data ----------------------
            super(...arguments);
            this.data = null;
        ...
        */
        ...
        receive(
            ...
            sender = null) {
            let message = new Message_1.Message(text, msgType);
        ...
        atachConnection(connection) {
            if (this.connection !== null) {
                ERROR_1.ERROR("Attempt to attach player connection"
        ...
        */
        addOfflineMessage(sender, message) {
            /// TODO
        ...
        postLoad(loadContents = true) {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this.data)
                    return;
                if (loadContents)
                    yield this.data.loadContents();
            });
        }
        // --------------- Protected methods ------------------
        // Send message to the connected player that command is not recognized.
        unknownCommand() {
            this.receive("Huh?!?", MessageType_1.MessageType.COMMAND);
        }
        // Creates a formatted string describing entity contents.
        printContents() {
            ERROR_1.ERROR("GameEntity.printContents() is not supposed"
        ...
        doQui(argument) {
            this.receive("You have to type quit--no less, to quit!", MessageType_1.MessageType.COMMAND);
        }
        doQuit(argument) {
            if (this.connection === null)
                ...
                return;
            this.receive("Goodbye, friend.. Come back soon!", MessageType_1.MessageType.COMMAND);
